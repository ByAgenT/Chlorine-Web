...
const Player = (props) => (
  <PlayerContainer>
    ...
    <ControlContainer>
      ...
      <ButtonsContainer>
        <BackControl onClick={() => { props.player.previousTrack(); }}/>
        <PlayControl onClick={() => { props.player.resume(); }}/>
        <PauseControl onClick={() => { props.player.pause(); }}/>
        <NextControl onClick={() => { props.player.previousTrack(); }}/>
      </ButtonsContainer>
